...
This is my home k8s cluster condensed into a git repository. [Flux](https://github.com/fluxcd/flux2) watches my [cluster]('./cluster') folder and makes changes on the fly to my cluster at home based on these manifests.

Feel free to open a [Github Issue](https://github.com/kashalls/home-cluster/issues/new/choose) or join the [k8s@home Discord](https://discord.gg/sTMX7Vh) if you have any questions.
...
My cluster is [k3s](https://k3s.io/) provisioned overtop Ubuntu 21.04 using the [Ansible](https://www.ansible.com/) galaxy role [ansible-role-k3s](https://github.com/PyratLabs/ansible-role-k3s). This cluster  sharing the same available resources on my nodes while I have a separate server for (NFS) file storage.
...
Thanks to Devin for getting me interested in k8s@home: https://github.com/onedr0p/home-cluster